...
- 4. 診斷 (Stress testing): - (1) 有兩種方式,若病患能適當的運動且休息時的心電圖沒有會干擾判斷缺血的特徵,可施行運動心電圖(Treadmill exercise test);若無法配合運動心電圖,可安排心臟核醫檢查(Thallium Tl 201)。(Ref. Harrison Fig 237-1) - (2) 運動心電圖 (Treadmill exercise test) - a. 慢慢增加運動強度,起碼要達到 max heart rare ( Source: [[sources/med3-book1-ch02|丙、缺血性心臟病]].
- #### (3) 心臟核醫檢查 (Thallium Tl 201) Source: [[sources/med3-book1-ch02|丙、缺血性心臟病]].
- b. 因此,利用核子醫學方法診斷心肌梗塞程度、範圍時,可利用 Dipyridamole 擴張 冠狀動脈來模擬 Stress test,檢查出灌流較差的區域。 Source: [[sources/med3-book1-ch02|丙、缺血性心臟病]].
