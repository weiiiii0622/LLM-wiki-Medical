...
aliases:
  - 'ASIA Impairment Scale, AIS (ASIA 脊髓損傷分級)'
...
以 sensory/motor level、sacral sparing 與 complete/incomplete injury 分級 SCI 嚴重度與預後。 本頁已整合至 `醫(六)第3冊復健`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
...
- 2. ASIA International Standards for Neurological Classification of SCI: Source: 醫(六)第3冊復健_乙、神經復健(神外) Page 51-84.
