...
- ...(WBC count > 15,000) | | | | case 為例) | • Electrolyte imbalances (hyponatremia: Na 5.0 mEq/L) | | | | | Elevated liver enzymes | | | | | • Decreased creatinine clearance (serum | n Cr > 1; CCr | | | | |-------|---------|---------------------------------------------------|---------------------|--| | 輕至中度一 | • 給予止吐 | 給予止吐及止痛藥 | | | | 門診治療 | • 每天 Source: [[sources/med6-book1-ch11|乙、不孕症(Infertility)]].
