...
aliases:
  - 'Serum-ascites albumin gradient, SAAG (血清腹水白蛋白梯度)'
...
SAAG 協助判斷腹水是否與門脈高壓相關。 本頁已整合至 `醫(三)第2冊肝內新陳代謝`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
...
- (C) 若有腹水且抽取出來呈透明淡黃色,其 serum-ascites albumin gradient (SAAG) 應 3.5),bilirubin (total) = 2.0 mg/dl (正常值 4,000),platelet = 8 K/mm³ (正常值 > 15 K)。最近常便秘,但又喜歡肉食,有一天,他被發現神智不清而被送至急診室,下列各項敘述,何者錯誤? - (A) 身體診察很可能會發現有撲拍性震顫 (flapping tremor) - (B) 抽血檢驗 ammonia (NH3) 值= 32 $\mu$ g/dl (正 Source: [[sources/med3-book2-ch23|戊、肝硬化]].
...
- 肝功能異常及黃疸這兩個章節算是肝膽內科的基本功,如果題目出判讀實驗室檢查數據,一定要拿分,因為比起其他東西,這些判讀有其原則性,較好掌握。腹水只要知道 SAAG 怎麼算、是什麼,也很好掌握。 Source: [[sources/med3-book2-ch08|辛、腸道疾病]].
