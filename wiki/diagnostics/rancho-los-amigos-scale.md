...
aliases:
  - 'Rancho Los Amigos scale (Rancho Los Amigos 認知功能量表)'
  - 'Rancho Los Amigos scale'
  - 'Rancho Los Amigos 認知功能量表'
tags:
  - medicine
  - diagnostic
  - auto-topic-node
...
用於描述 TBI 後認知與行為恢復階段，從無反應到有目的且適切的反應。 本頁已整合至 `醫(六)第3冊復健`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
