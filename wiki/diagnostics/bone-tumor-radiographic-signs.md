...
aliases:
  - 'Bone tumor radiographic signs (骨腫瘤影像徵象)'
  - 'Bone tumor radiographic signs'
  - '骨腫瘤影像徵象'
tags:
  - medicine
  - diagnostic
...
骨腫瘤 X-ray 徵象包含 periosteal reaction、lytic/blastic pattern、matrix calcification 與 cortex destruction。 本頁已整合至 `醫(五)第6冊骨科`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
...
- [[conditions/simple-bone-cyst|Simple bone cyst / unicameral bone cyst (單腔骨囊腫)]]
