...
- 根據 DSM-IV-TR 的定義:在一段特定期間內有強烈害怕或不舒服的感受,突然發生下列症狀中四項或以上,並且在十分鐘內達到最嚴重的程度: Source: [[sources/med4-book3-ch03|丙、焦慮性疾患]].
- #### DSM-5 的診斷準則:特定場所畏懼症(Agoraphobia): Source: [[sources/med4-book3-ch03|丙、焦慮性疾患]].
- **DSM-5 的診斷準則**:恐慌發作(Panic attack)在一段特定期間內有強烈害怕或不舒服的感受,突然發生下列症狀中四項或以上,並且在十分鐘內達到最嚴重的程度: Source: [[sources/med4-book3-ch03|丙、焦慮性疾患]].
- #### 根據 DSM-IV-TR 的診斷準則: Source: [[sources/med4-book3-ch07|庚、兒童與青少年的精神疾病]].
- 2. 上述症狀在七歲前即出現。→ DSM-5 改為 12 歲。 Source: [[sources/med4-book3-ch07|庚、兒童與青少年的精神疾病]].
