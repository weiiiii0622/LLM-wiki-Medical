...
用血清標記判讀 HAV/HBV/HCV 等感染狀態、免疫與傳染性。 本頁已整合至 `醫(四)第1冊小兒`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
...
- ...ion phase | | | phase | | | | | 表徵 | 嬰幼兒被感染 | 兒童進入青年後,隨著 | 重要的里程碑是e抗原 | 少數患者可能因病毒突 | | | 後,免疫機制尚 | 免疫機能的成熟,免疫 | 抗體血清轉換 (HBeAg | 變或免疫機能下降,造 | | | 不健全故容忍病 | 系統試圖清除病毒,攻 | 消失,Anti-HBe出現), | 成病毒的再活化,HBV | | | 毒存在,不會對 | 擊被感染的肝細胞,因 | 代表宿主免疫機制已大 | DNA 再度上升 | | | 被感染的細胞發 | 此會引起肝組織發炎血 | 幅控制病毒的感染狀 | HBeAg 轉陽或因 precore | | | 動攻擊,因此病 | 中病毒量忽高忽低,反 | 況。HBV D Source: [[sources/med3-book2-ch17|丁、肝 炎]].
- ...----------------------------------------|----------------------------------------|--------------------|-------------| | HBsAg | + | _ | + | + | + | _ | | HBeAg | + | _ | + | - | _ | - | | Anti-HBs | - | + | - | - | - | + | | Anti-HBe | | + | - | + | + | _ | | IgM anti-HBc | + | = 0.70 | + | - | - | _ | | IgG anti-HBc | _ | + | + | + | + | - | Source: [[sources/med3-book2-ch17|丁、肝 炎]].
