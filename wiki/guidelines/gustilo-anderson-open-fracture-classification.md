...
aliases:
  - 'Gustilo-Anderson open fracture classification (Gustilo 開放性骨折分類)'
...
依傷口大小、污染、軟組織覆蓋與血管損傷分級開放性骨折，影響抗生素、清創與固定策略。 本頁已整合至 `醫(五)第6冊骨科`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
...
- (C) 3. 關於脛骨開放性骨折的 Gustilo classification,下列敘述何者錯誤? Source: [[sources/med5-book6-ch03|丙、創 傷]].
