...
Guideline pages and recommendation frameworks.

## Pages

- [[guidelines/acc-aha-heart-failure-stages|ACC/AHA heart failure stages (ACC/AHA 心衰竭分期)]] - 依危險因子、結構病變、症狀與末期狀態分期。
- [[guidelines/acr-eular-ra-classification-criteria|ACR/EULAR RA classification criteria (RA 分類準則)]] - RA 分類以關節侵犯、serology、acute phase reactants 與症狀時間加總評分。
- [[guidelines/aids-defining-conditions|AIDS-defining conditions (AIDS 定義疾病)]] - AIDS 依 CD4 < 200 或特定 opportunistic infection/腫瘤定義，部分地區對 TB 定義不同。
- [[guidelines/ards-berlin-definition|Berlin definition of ARDS (ARDS Berlin 定義)]] - ARDS 以時間、影像、氧合與非心因性水腫定義。
- [[guidelines/cancer-screening|Cancer screening (癌症篩檢)]] - 針對無症狀族群以年齡與風險分層安排癌症早期偵測。
- [[guidelines/ccs-angina-classification|CCS angina classification (CCS 心絞痛分級)]] - 以活動受限程度分級穩定型心絞痛。
- [[guidelines/diabetes-care-targets|Diabetes care targets (糖尿病照護目標)]] - 糖尿病控制目標包含血糖、血壓、血脂與生活型態。
- [[guidelines/difficult-airway-management|Difficult airway management (困難氣道處理)]] - 困難氣道處理需預先評估、準備替代氣道、限制嘗試次數，並保留氧合與外科氣道選項。
...
- [[guidelines/head-and-neck-cancer-staging|Head and neck cancer staging (頭頸癌分期)]] - 頭頸癌分期依部位、T/N/M、HPV/p16 等因素不同，決定治療與預後。
...
- [[guidelines/nyha-functional-class|NYHA functional class (NYHA 心功能分級)]] - 以活動受限程度分級心衰竭症狀。
