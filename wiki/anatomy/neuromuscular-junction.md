...
aliases:
  - 'Neuromuscular junction, NMJ (神經肌肉接合處)'
...
motor neuron 與 skeletal muscle 之間以 acetylcholine 傳遞訊號，是 MG、Lambert-Eaton、botulism 的病變位置。 本頁已整合至 `醫(六)第4冊麻醉耳鼻喉`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
...
- (2) 自發性活動電位 (spontaneous activity): - a. 當針極刺入肌肉後靜止不動後,肌肉會處於完全放鬆狀態,此時正常應記錄不到活動電位。但假使針極正好位於 neuromuscular junction (NMJ)內的運動終板 (motor end plate),則可見到兩種正常活動電位: - (a) 微運動終板電位 (miniatual end plate potential, MEPP): 此為運動終板中自發性的量子釋放,每五毫秒 (ms) 一次,每次電波振幅為 $10\sim50~\mu V$ 。 也稱為 end-plate noise。 - \* 聲音聽起來像 "sea shell murmur" (貝殼里的海聲)。 - (b Source: [[sources/med6-book3-ch09|壬、神經學檢查]].
...
- f. 局部肌肉注射肉毒桿菌:將肉毒桿菌毒素注射在肌肉內,作用在 neuromuscular junction 抑制 acetylcholine 的釋放。注射後須 24~72 小時才生效,也可持續 3~6 個月。好處是注射程序相對簡單,可以解剖位置定位後施打,亦可用超音波 Source: [[sources/med6-book3-ch06|己、小兒復健]].
...
- | | 症狀 | 記法(自創記法,僅供參考) | |---------------|-------------|---------------| | 神經病變 | 遠端無力 | 神經支配如水流供應, | | 加中程/内发 | (無法梳頭髮、爬樓梯) | 不足時,遠端先無力 | | 神經肌肉接合處疾病 | 近端無力 | 近端肌肉較多, | | 肌肉病變 | (無法扣鈕釦) | 有病變時,近端較能顯現 | Source: [[sources/med4-book4-ch08|辛、肌肉病變]].
- #### II. 神經肌肉接合處疾病 (Neuromuscular Junction Disease) Source: [[sources/med4-book4-ch08|辛、肌肉病變]].
