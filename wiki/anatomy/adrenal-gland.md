...
腎上腺皮質與髓質分泌 glucocorticoid、mineralocorticoid、androgen 與 catecholamine。 本頁已整合至 `醫(五)第5冊泌尿`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
...
- (c) M: M0 無遠端轉移; M1: - i. M1a:轉移到非局部(non-regional,超過局部)的淋巴結。(超過真骨盆,也就是超過總髂動脈分岔處之上) - ii. M1b:轉移到骨頭《記b = bone》(記b = bone,最常到中軸骨的腰椎,造成骨增生性(osteoblastic)病灶。其次是近端股骨、恥骨、胸椎。) - iii. M1c:轉移到其他部位。(最常轉移位置依序是到肺,膀胱,肝和腎上腺) Source: [[sources/med5-book5-ch04|丁、攝護腺]].
- 下垂體前葉,使得其分泌 LH 及 FSH 隨血流到睪丸,LH 刺激睪丸內雷迪細胞(Leydig cells)合成睪固酮,這路徑合成的睪固酮占總量 95%。另外 5% 睪固酮由身體其他組織(如腎上腺)從類固醇(steroid)轉化而來。 Source: [[sources/med5-book5-ch04|丁、攝護腺]].
