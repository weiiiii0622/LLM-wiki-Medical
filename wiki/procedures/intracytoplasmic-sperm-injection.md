...
aliases:
  - 'Intracytoplasmic sperm injection, ICSI (單一精蟲卵細胞質內注射)'
...
將單一精蟲注入卵細胞，常用於 severe male factor infertility 或 IVF fertilization failure。 本頁已整合至 `醫(六)第1冊婦產`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
