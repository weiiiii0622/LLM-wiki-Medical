...
aliases:
  - 'Intravitreal injection (玻璃體腔內注射)'
...
將 anti-VEGF、steroid 或抗生素注入玻璃體腔，用於 macular edema、wet AMD、endophthalmitis 等。 本頁已整合至 `醫(六)第2冊眼科`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
