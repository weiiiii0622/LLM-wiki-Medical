...
腎臟常見結構異常，多數無症狀；影像有 septa、nodules 或 enhancement 時需依 Bosniak 分級評估惡性風險。 本頁已整合至 `醫(五)第5冊泌尿`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
...
- [[diagnostics/bosniak-renal-cyst-classification|Bosniak renal cyst classification (Bosniak 腎囊腫分級)]]
