...
aliases:
  - 'Peripheral arterial disease / PAOD (周邊動脈阻塞疾病)'
...
下肢或周邊動脈粥狀硬化狹窄造成 claudication、休息痛、ulcer/gangrene，需評估危險因子、ABI 與血管重建時機。 本頁已整合至 `醫(六)第3冊復健`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
