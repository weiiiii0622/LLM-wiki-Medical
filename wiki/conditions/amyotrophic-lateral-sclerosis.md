...
aliases:
  - 'Amyotrophic lateral sclerosis, ALS (肌萎縮側索硬化症)'
...
同時侵犯 UMN 與 LMN 的 motor neuron disease，表現進行性無力、萎縮、束顫與 spasticity。 本頁已整合至 `醫(四)第4冊神內`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
