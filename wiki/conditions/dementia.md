...
aliases:
  - 'Dementia / major neurocognitive disorder (失智症)'
...
後天認知功能下降影響日常生活，需區分退化性、血管性、代謝、藥物、憂鬱與譫妄。 本頁已整合至 `醫(四)第4冊神內`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
...
- [[conditions/dementia-with-lewy-bodies|Dementia with Lewy bodies, DLB (路易氏體失智症)]]
- [[conditions/frontotemporal-dementia|Frontotemporal dementia, FTD (額顳葉型失智症)]]
