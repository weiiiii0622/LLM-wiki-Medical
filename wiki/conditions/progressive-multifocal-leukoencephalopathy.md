...
aliases:
  - 'Progressive multifocal leukoencephalopathy, PML (進行性多灶性白質腦病)'
...
JC virus 在免疫低下者造成 CNS demyelination，表現進行性局部神經缺損。 本頁已整合至 `醫(四)第4冊神內`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
