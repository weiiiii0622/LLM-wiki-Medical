...
aliases:
  - 'Extensor tendon injury of hand (手部伸肌肌腱損傷)'
  - 'Extensor tendon injury of hand'
  - '手部伸肌肌腱損傷'
tags:
  - medicine
  - condition
...
手部伸肌腱損傷可依 zone 造成 mallet finger、boutonniere deformity 或伸指障礙，治療依位置與斷裂程度。 本頁已整合至 `醫(五)第6冊骨科`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
