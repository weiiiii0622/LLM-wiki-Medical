...
aliases:
  - 'Subacute combined degeneration (亞急性合併退化症)'
...
vitamin B12 deficiency 造成 posterior columns 與 corticospinal tracts 退化。 本頁已整合至 `醫(四)第4冊神內`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
