...
aliases:
  - 'Poststroke shoulder pain (中風後肩痛)'
...
中風後肩痛可由 subluxation、spasticity、capsulitis、CRPS、rotator cuff injury 或 positioning 不良造成。 本頁已整合至 `醫(六)第3冊復健`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
