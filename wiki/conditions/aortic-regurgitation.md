...
- ...| (A) 重度貧血(B) 甲狀腺機能亢進 | | | | | (C) 主動脈瓣狹窄 | | | | | (D) 肺動靜脈交通 | | | | | 【詳解】(C) 寬脈壓差(wide pulse pressure) 應該是主動脈瓣閉鎖不全(AR)才會有。 | | | (B) | 24. | 承上題,病人接受理學檢查時,以手按壓上腹部,可觀察到頸靜脈 | 95(二)專 | | | | 波上升超過1公分,此一檢查方法稱為: | 內 2-13 | | | | (A) Kussmaul's sign | | | | | (B) hepato-jugular reflux | | | | | (C) Murphy's sign | | | | | (D) de Musset's sig Source: [[sources/med3-book1-ch04|壬、心臟衰竭]].
- (D) 主動脈瓣閉鎖不全 (aortic regurgitation ) Source: [[sources/med3-book1-ch11|辛、心包疾病]].
