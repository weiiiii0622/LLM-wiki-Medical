...
- 修格蘭氏症候群 (Sjögren's syndrome, SS): 有時合併於 RA、SLE Source: [[sources/med3-book4-ch03|丙、其他結締組織病]].
- ...stone | Drug induced LE | | Nucleo-plasmic | Ribonucleo-Protein Centromere (Ic 硬皮病) | 細斑點型(Fine Speckled) | SSA · SSB | Sjögren's syn. | | (核質) | | 粗斑點型 | Anti-Sm | SLE | | | | (Coarse S.) | Anti-RNP | MCTD,雷諾氏現象 | | | | 不連續斑點(Discrete S.) | Anti-centromere | lcSSc ( C R E ST syn.) | | Nucleolar (dc 硬皮病)(核仁) | | | Anti-Scl 70 | dcSSc (ILD ↑ ) | Source: [[sources/med3-book4-ch03|丙、其他結締組織病]].
