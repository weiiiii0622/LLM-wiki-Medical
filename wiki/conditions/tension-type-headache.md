...
常見 primary headache，呈雙側壓迫緊箍感，通常無明顯噁心或神經缺損。 本頁已整合至 `醫(四)第4冊神內`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
...
- | 分類 | 緊縮型頭痛(Tension headache) | 偏頭痛(Migraine) | 叢發型頭痛(Cluster headache) | |-----|-----------------------------|-------------------------------------------------------------------------------|-----------------------------| | 好發於 | 緊 Source: [[sources/med4-book4-ch03|丙、頭 痛]].
