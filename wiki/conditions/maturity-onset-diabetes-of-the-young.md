...
aliases:
  - 'Maturity-onset diabetes of the young, MODY (青少年發作成年型糖尿病)'
...
單基因 beta-cell 功能異常造成年輕發病糖尿病，家族史與非典型 type 1/type 2 表現提示。 本頁已整合至 `醫(四)第1冊小兒`；若同一 topic 也出現在舊來源，來源與重點會保留並合併。
